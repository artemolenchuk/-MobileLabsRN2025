...
export default function FileManagerScreen() {
    ...
    const {
        ...
        getFileDetails: getFileDetailsFromHook,
        handleDeleteItem,
        handleCreateItem,
        handleGoUp,
    ...
    const openDetailsModal = useCallback((item: FileSystemItem) => {
        if (!item.isDirectory) {
            getFileDetailsFromHook(item.uri, item.name);
        }
    }, [getFileDetailsFromHook]);

    const openDeleteConfirmationModal = useCallback((item: FileSystemItem) => {
        setItemToDeleteUri(item.uri);
        setItemToDeleteName(item.name);
        setIsDeleteModalVisible(true);
    }, [setItemToDeleteUri, setItemToDeleteName, setIsDeleteModalVisible]);
